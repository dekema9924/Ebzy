  ...
  return (
    <>
      ...
      <form className='flex flex-wrap gap-3'>        {
        ...
        <input onClick={Handlecategory} type='text' readOnly value="Electronics" className='border-2 outline-none cursor-default border-gray-300 rounded-2xl px-4  font-thin'/>
        <input onClick={Handlecategory} type='text' readOnly value="Shoes" className='border-2 outline-none border-gray-300 cursor-default rounded-2xl px-4 font-thin'/>
        <input onClick={Handlecategory} type='text' readOnly value="Furniture" className='border-2 outline-none border-gray-300 cursor-default rounded-2xl px-4 font-thin'/>
        <input onClick={Handlecategory} type='text'  readOnly value="All Products" className='border-2 outline-none border-gray-300 cursor-default rounded-2xl px-4 font-thin'/>
      </form>

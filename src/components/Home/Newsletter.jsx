...
function Newsletter() {
    return (
        <form className='flex flex-col gap-5 items-center justify-center bg-gray-100 h-80' action="">
            ...
            <div className='flex sm:flex-col gap-6 items-center justify-center '>
                <input className='w-[400px] text-gray-700 sm:w-80 h-16 bg-white outline-none text-gray-200 rounded-2xl pl-10  ' type="email" name="" id="" placeholder='your email address' />
